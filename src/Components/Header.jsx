...
//                       hover:bg-white/10 
//                       ${activeLink === id ? "bg-white/15 text-white"
...
// export default Header;
 ...
 import React, { useEffect, useState } from 'react';
import "./header.css";
import { FaFileAlt, FaHome, FaLaptopCode, FaUser, FaBriefcase, FaGraduationCap, FaCode, FaEnvelope, FaBars } from "react-icons/fa";
...
function Header() {
  ...
  const navLinks = [
    ...
    { id: "resume", icon: FaFileAlt, text: "Resume", href: "/resume" }, // External resume page
  ];
